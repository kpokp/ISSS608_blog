...
In this article, we will show you how to plot a figure with multiple histograms by using [__ggplot2__](https://ggplot2.tidyverse.org/) and [__ggpubr__](https://cran.r-project.org/web/packages/ggpubr/index.html) packages. 
