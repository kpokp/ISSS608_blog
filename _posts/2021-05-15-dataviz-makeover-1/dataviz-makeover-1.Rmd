...
|33| Add annotation to points when exports hit the minimal value after declining drastically.| ![](./images/step33.png){#id .class width=100%}|
...
|35| Hide the worksheets and publish the dashboard to Tableau Public. Tweak the size of the dashboard to ensure that the visualisation can be view properly on desktop (at the very least).| ![](./images/step35.png){#id .class width=100%}|

:::


# 5. Major Observations
1. Annual merchandise trade value between Singapore and major partners generally fell in 2020, except for Taiwan and Hong Kong. The dip year-on-year is the greatest for Malaysia, which registered a $9.5B decline, driven mainly by lower exports. The next biggest dip comes from United States, which registered a $2.6B year-on-year decline, which instead is driven by lower imports. 
2. Us change from net importer to net exporter
3. 
